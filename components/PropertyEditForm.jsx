...
function PropertyEditForm({ property }) {
  const updatePropertybyIdHandler = updateProperty.bind(null, property._id);
  return (
    <form action={updatePropertybyIdHandler}>
        ...
        <div className="grid grid-cols-2 gap-2 md:grid-cols-3">
          ...
          <div>
            <input
              ...
              value="Balcony/Patio"
              className="mr-2"
              defaultChecked={property.amenities.includes("Balcony/Patiog")}
            />
