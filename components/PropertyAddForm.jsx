...
export default function PropertyAddForm() {
  ...
  async function handleSubmit(e) {
    ...
    // Step 2 — Replace local images with Cloudinary URLs
    formData.delete("images");
    uploadedUrls.forEach((url) => formData.append("imageUrls", url));

    // Step 3 — Submit property data to your server action
    const res = await fetch("/properties/add", {
      method: "POST",
      body: formData,
    });
  ...
  return (
    <form
      ...
      className="mx-auto max-w-2xl rounded-xl bg-white p-4 shadow"
    >
      ...
      <input type="file" name="images" multiple required className="mb-4" />
      ...
      >
        {uploading ? "Uploading Images..." : "Add Property"}
      </button>
    </form>
  );
}
